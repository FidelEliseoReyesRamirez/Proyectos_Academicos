...
export default function ResetPassword({ token, email }: Props) {
    ...
    return (
        <>
            <Head title="Restablecer contraseña — UNIVALLE" />
                ...
                <main className="reset-form-panel">
                    <div className="reset-form-wrap">
                        ...
                        <div className="form-header">
                            <div className="form-eyebrow">Nueva contraseña</div>
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="input-wrap">
                                            ...
                                            <input
                                                ...
                                                className={`field-input with-toggle${errors.password_confirmation ? ' has-error' : ''}`}
                                            />
                                            ...
                                            >
                                                <IconEye off={showPasswordConfirmation} />
                                            </button>
                                        </div>
                ...
                <aside className="reset-side">
                    ...
                    <div className="side-content">
                        ...
                        <h2 className="side-headline df">
                            Define una<br />
                            contraseña nueva<br />
                            <span className="side-headline-gold">y segura.</span>
                        </h2>

                        <p className="side-desc">
                            Utiliza una contraseña distinta a la anterior y evita compartirla con terceros.
                        </p>
                        ...
                        <div className="side-security-card">
                            ...
                            <p className="side-security-text">
                                Usa una combinación de letras, números y símbolos. La contraseña debe ser fácil de recordar para ti y difícil de adivinar para otros.
                            </p>
                        </div>
                    </div>
                </aside>
