                    ...
                    <section className="users-card">
                        <div className="users-card-header">
                            ...
                            <p className="users-description">
                                Modifica el nombre, teléfono, rol y estado del usuario sin eliminar su historial. El correo se mantiene bloqueado por trazabilidad.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="grid gap-4 p-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                />
                                <p className="mt-1 text-xs text-[#6E6458] dark:text-[#A9978D]">
                                    El correo no se modifica para conservar trazabilidad.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    className="select-input disabled:cursor-not-allowed disabled:opacity-70"
                                    value={form.data.rol}
                                    disabled={restricciones.es_usuario_actual || restricciones.es_ultimo_coordinador}
                                ...
                                {restricciones.es_usuario_actual && (
                                    <p className="mt-1 text-xs font-medium text-[#6E6458] dark:text-[#A9978D]">
                                        No puedes modificar tu propio rol.
                                    </p>
                                )}

                                {restricciones.es_ultimo_coordinador && (
                                    <p className="mt-1 text-xs font-medium text-[#6E6458] dark:text-[#A9978D]">
                                        Este usuario es el último coordinador activo; su rol no puede modificarse.
                                    </p>
                                )}
